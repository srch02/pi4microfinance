...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadMembers() {
        ...
        // 20 Members with different CIN numbers, emails and passwords
        Member[] members = new Member[]{
            createMember("12345678", "member1@example.tn", "password123"),
            createMember("23456789", "member2@example.tn", "password123"),
            createMember("34567890", "member3@example.tn", "password123"),
            createMember("45678901", "member4@example.tn", "password123"),
            createMember("56789012", "member5@example.tn", "password123"),
            createMember("67890123", "member6@example.tn", "password123"),
            createMember("78901234", "member7@example.tn", "password123"),
            createMember("89012345", "member8@example.tn", "password123"),
            createMember("90123456", "member9@example.tn", "password123"),
            createMember("01234567", "member10@example.tn", "password123"),
            createMember("11223344", "member11@example.tn", "password123"),
            createMember("22334455", "member12@example.tn", "password123"),
            createMember("33445566", "member13@example.tn", "password123"),
            createMember("44556677", "member14@example.tn", "password123"),
            createMember("55667788", "member15@example.tn", "password123"),
            createMember("66778899", "member16@example.tn", "password123"),
            createMember("77889900", "member17@example.tn", "password123"),
            createMember("88990011", "member18@example.tn", "password123"),
            createMember("99001122", "member19@example.tn", "password123"),
            createMember("00112233", "member20@example.tn", "password123")
        };
    ...
    private Member createMember(String cinNumber, String email, String password) {
